...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{url('/History')}}"><img src="{{ asset('img/logo.png') }}" width="30px" height="30px" style="border-radius: 50%;" alt="Logo"> Voucher App</a>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_nav" style="position:relative;float:right">
